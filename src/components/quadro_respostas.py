...
class QuadroRespostas(ctk.CTkFrame):
    ...
    def __init__(self, master, estado: GerenciadorEstados):
        ...
        ctk.CTkLabel(self, text='Resposta Prompt Resumido').grid(row=0, column=0, sticky='nsew',  padx=10, pady=(10,5))
        ...
        ctk.CTkLabel(self, text='Resposta Prompt Original').grid(row=2, column=0,  sticky='nsew', padx=10, pady=(10,5))
