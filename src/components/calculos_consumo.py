...
class GraficosConsumo(ctk.CTkFrame):
    ...
    def desenhar_grafico(self, ax, canvas, titulo: str, unidade_y: str, valores: list, cor: str):
        ax.clear() 
        categorias = ['Gemini', 'Ollama']
        cores = [cor, '#888888'] 
